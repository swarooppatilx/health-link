...
async function createDummyData() {
  ...
  const hospital2 = await prisma.hospital.create({
    data: {
      ...
      description: "A trusted medical facility with state-of-the-art equipment.",
      availableServices: ["Cardiology", "Orthopedics", "Radiology", "Maternity"],
      availableBeds: 50,
  ...
  const message1 = await prisma.message.create({
    data: {
      ...
      content: "Please remember to bring your medical records to your next appointment.",
    },
  });
