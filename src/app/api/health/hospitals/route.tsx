...
const generateHospitalLink = (id: string) =>
  `/services/appointment/hospitals/${id}`;
...
const hospitalItems: HospitalItem[] = [
  {
    ...
    description:
      'A premier healthcare institution with a wide range of services.',
  ...
  },
  {
    ...
    description:
      'Offers advanced healthcare services with a focus on patient care.',
  ...
  },
  {
    ...
    description:
      'Features state-of-the-art medical equipment and skilled professionals.',
    availableServices: [
      'Internal Medicine',
      'Orthopedic Surgery',
      'Anesthesiology',
