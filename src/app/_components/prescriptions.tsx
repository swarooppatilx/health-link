...
<div className="bg-white p-4 flex justify-between items-center">
  <div className="flex items-center">
    <FontAwesomeIcon icon={faChevronLeft} className="text-blue-600 w-4 h-4 mr-2" />
...
<div className="flex-grow p-4">
  <h1 className="text-2xl font-bold mb-4">Check the pharmacy this will be sent to</h1>
  ...
  <div className="bg-white rounded-lg p-4 mb-4 flex items-center">
    <FontAwesomeIcon icon={faClock} className="text-blue-600 w-5 h-5 mr-2" />
    <span className="text-blue-600 font-semibold">Opening times</span>
  </div>

  <a href="#" className="text-blue-600 block mb-8">Change your nominated pharmacy</a>
